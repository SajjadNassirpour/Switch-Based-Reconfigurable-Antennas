...
function [final_sum_rate, Switch_mat]=BIS_low_complexity_3_half(K,M,iters,pow_mat,H_noisy,H_nonoise,Ns,L,noise_cond)
    ...
    for pow_idx=1:length(pow_mat)
        ...
        for iter=1:iters
            ...
            % Rate at each user
            rate_BIS(1,iter)=0.5*0.5*log2(1+SINR_BIS);
