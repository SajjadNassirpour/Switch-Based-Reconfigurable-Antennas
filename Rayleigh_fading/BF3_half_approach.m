% -- BF method with {-1,0,+1} and two timeslots -- %
% K :              Number of users
...
function sum_rate_BF=BF3_half_approach(K,M,iters,pow_mat,H_noisy,H_nonoise,noise_cond)
    ...
    for pow_idx=1:length(pow_mat)
        ...
        for iter=1:iters
            ...
            % Rate at each user
            rate_BF(1,iter)=0.5*0.5*log2(1+SINR_BF);
        end
