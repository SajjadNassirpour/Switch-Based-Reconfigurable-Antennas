...
function [LM_string,eval]=LS_algo_ref_diff_pow(ini_string,H,t_p,n_p,mode,r)
    eval=0;    
    M=length(ini_string);
    S_star=ini_string;
    ...
    if mode==1
        ...
        score_max=Filled_func_diff_pow(S_star,S_star,r,H,t_p,n_p);
    end
    ...
    for i1=1:M
        ...
        if sum(G1==0)~=M
            ...
            if mode==1
                ...
                score=Filled_func_diff_pow(S_star,G1,r,H,t_p,n_p);
            end
            if score<=score_max 
                score_max=score;
                LM_string=G1;
